					  	...
					  	<div class="row">
					  			...
					  			<form action="" method="POST">
					  				...
					  				<div class="form-group">
					  					...
					  					<select class="form-control" name="pcat">
					  						...
					  						<?php 
					  							$categories = get_categories(array("hide_empty" => 0)); foreach($categories as $category) {
					  							$selected=  '';
					  							if ($postcateg[0]->term_id == $category->term_id) { $selected =  'selected'; }
					  		...
					  		<div class="col-md-6">
					  			<table class="table table-bordered" id="allposttbl">
					  				...
					  				<tbody>
					  					<?php $args = array('post_type'=>'post','orderby'=>'ID','post_status'=>'publish','order'=>'DESC',
												'posts_per_page'=> -1);
												$result = new WP_Query( $args );
												if ( $result-> have_posts() ) { $num =1; ?>
