		  ...
		  <div id="printArea" class="col-md-12 printBG" >
			  ...
			  <div class="printArea" style="margin: 10px 30px 0;">
					<style type="text/css">
						...
						#itemMainBox .itemWaterMark  img{opacity: .12;width: 320px;}
									...
									<div id="itemMainBox">
										...
										<div style="padding: 15px 30px 5px">
							  			...
							  			<div class="princSign" style="text-align: center;">
							  				<img width="110" src="<?= $s3sRedux['principalSign']['url'] ?>"><br>..................................<br>
							  			(<?= $s3sRedux['inst_head_title'] ?> )
							  			</div>
							  			<div style="clear: both;text-align: center;padding: 10px 0 5px">
							  				<i style="font-size: 10px;color: #888;">Generated by বর্ণমালা, Developed by MS3 Technology BD,Shibgonj, Sylhet. Email: bornomalaems@gmail.com</i>
							  			</div>
							  		</div>
							  	</div>
