		...
		<div class="container-fluid maxAdminpages" style="padding-left: 0">
			...
			<div class="row">
		        ...
		        <a class="pull-right btn btn-primary" href="?page=attendance">Add Attendance</a>
		         <a class="pull-right btn btn-primary" href="?page=attendance&view=leave">
	       		Add Leave
		      </a>
		      </h2>
														...
														<tr>
															...
															<?php for ($i=1; $i < ($dates+1) ; $i++) {
																...
																if(date('D', strtotime($date)) == 'Fri' || date('D', strtotime($date)) == 'Sat' ){
																    	...
																    	$attnd = '<span style="color:white">X</span>';
																	echo "<td style='background:blue'>$attnd</td>";
																}
																else{
							  			...
							  			<form action="" method="POST">
							  				<div class="row">
								  				...
								  				<div class="form-group col-md-3 col-sm-4 col-xs-6">
								  				 ...
								  				 <div class="form-group col-md-3 col-sm-4 col-xs-6">
								  				     <br>
						  						<input class="btn btn-primary" type="submit" name="addLeave" value="ADD">
							  				</div>
							  				</div>
							  			...
							  			<form action="" method="POST">
							  				<div class="row">
							  					...
							  					<div class="form-group col-md-3 col-sm-4 col-xs-6">
							  						...
							  						<label> Year : 
							  							<input class="form-control" type="text" name="attyear" value="<?= $year ?>" readonly>
							  						</label>
							  					</div>
