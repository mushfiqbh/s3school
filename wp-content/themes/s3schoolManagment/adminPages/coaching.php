									...
									?>
									  ...
									  ?>
					  					<td>
											...
											<input style="margin-top:5px;" class="form-control" type="date" name="date[<?= $value->studentid ?>]" value="<?= isset($value->date) ? $value->date : '' ?>" placeholder="Transport Activation Date">
											<?php
												}else{
											?>
