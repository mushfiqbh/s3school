		...
		<?php if(isset($_GET['syear'])){ ?>
		  ...
		  <div id="printArea" class="col-md-12 printBG" >
			 ...
			 // 		$exam 		= @$_GET['exam'];
			  		...
			  		if (!isset($_GET['bord'])) {
			  			$query = "SELECT stdName,stdGender,infoRoll,className,sectionName,stdImg,groupName,infoYear,stdPhone,stdFather,stdMother,spPosition,spPoint, stdPermanent, stdBrith FROM ct_student
								...
								LEFT JOIN ct_studentPoint ON ct_studentinfo.infoStdid = ct_studentPoint.spStdID AND ct_studentPoint.spYear = '$year' AND ct_studentPoint.spClass = $class
									...
									?>
										...
										<div id="wrapper"></div>
											<div style="padding: 50px 30px; ">
												...
												<div class="itemInfo">
									  			<h3 style="text-transform: uppercase;margin-top:150px">To Whom It May Concern</h3>
												</div>
												<div style="width: 100%;">
													<p >
														...
														of <b><u><?= $value->stdFather ?></u></b> and 
													<b><u><?= $value->stdMother ?></u></b>, <?= $value->stdPermanent ?>. 
													<?= ($value->stdGender == 0) ? 'She' : 'He' ?>	is a student of  <b>Class: <u><?= $value->className ?></u></b>. 
													Following <b> the year of <?= $year?></b>. According to admission register <?= ($value->stdGender == 0) ? 'Her' : 'His' ?>
													date of birth is <b><?= date('d-m-Y',strtotime($value->stdBrith))?></b>. So far I know <?= ($value->stdGender == 0) ? 'she' : 'he' ?> bears a good moral character.
													
													<p style="padding-left: 20px"> <b>I wish <?= ($value->stdGender == 0) ? 'her' : 'his' ?> bright future in life.</b></p>
										  		<table style="width: 100%; margin-top: 360px;">
										  			<tr>
										  				<td>
										  					<p>Writer: .................</p>
										  					<!--<p>Date: <?= date('d-m-Y') ?> </p>-->
