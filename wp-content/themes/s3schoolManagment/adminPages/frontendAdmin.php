									...
									<a class="managmentItem" href="<?= home_url('admin-teacher'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Teachers</h3><hr>
											</div>
										</div>
									</a>
								</div>
						  	...
						  	<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-student'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Student</h3><hr>
											</div>
										</div>
									</a>
								</div>
							 	...
							 	<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-attendance'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Attendance</h3><hr>
											</div>
										</div>
									</a>
								</div>
								...
								<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-class'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Class</h3><hr>
											</div>
										</div>
									</a>
								</div>
								...
								<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-section'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Section</h3><hr>
											</div>
										</div>
									</a>
								</div>
								...
								<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-group'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Group</h3><hr>
											</div>
										</div>
									</a>
								</div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-subject'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Subject</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-exam'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Exam</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-examattendance'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Exam attendance</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-admitcard'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Admit Card</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-seatcard'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Seat Card</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-resultpublish'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Result Publish</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('result-summery'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Result Summery</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('cgpa-genarate'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">CGPA Genarate</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('progress-report'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Progress Report</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-result'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Result</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-meritlist'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Merit List</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-faillist'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Fail List</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-tabulation2'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Tabulation Sheet2</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('all-marksheet'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">All MarkSheet</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-promotion'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Promotion</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>	
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('auto-promotion'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Auto Promotion</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>	
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('cgpa-promotion'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">CGPA Promotion</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>	
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('demotion'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Demotion</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>	
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-revenue'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Accounts</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('student-fee-management?page=studentFeeManagement&view=addFee'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Student Fee</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('datewise-fees-information'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Fee Reports</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								  ...
								  <div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('coaching'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">Coaching Fee etc.</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
								...
								<div class="col-md-3 col-sm-4">
									  <a class="managmentItem" href="<?= home_url('admin-sms'); ?>">
										  <div class="media">
											  ...
											  <div class="media-body">
												  <h3 class="media-heading">SMS</h3><hr>
											  </div>
										  </div>
									  </a>
								  </div>
					  		...
					  		<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-subject'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Add Subject</h3><hr>
											</div>
										</div>
									</a>
								</div>
								...
								<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-exam'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Create Exam</h3><hr>
											</div>
										</div>
									</a>
								</div>
						  	...
						  	<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-result'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Update Result</h3><hr>
											</div>
										</div>
									</a>
								</div>
				  ...
				  <div class="panel-body">
				  	<div class="row">
				  		...
				  		<?php if($haveAccess || $aidcard){ ?>
						  	<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-idcard'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">ID Card</h3><hr>
											</div>
										</div>
									</a>
								</div>
								...
								<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-testimonial'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">Testimonial</h3><hr>
											</div>
										</div>
									</a>
								</div>
							...
							<?php if($haveAccess || $atestimonial){ ?>
								<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('concern-letter'); ?>">
										<div class="media">
											<div class="media-left">
												<span class="dashicons dashicons-networking"></span>
											</div>
											<div class="media-body">
												<h3 class="media-heading">Concern Letter</h3><hr>
											</div>
										</div>
									</a>
								</div>
								...
								<div class="col-md-3 col-sm-4">
									<a class="managmentItem" href="<?= home_url('admin-tc'); ?>">
										<div class="media">
											...
											<div class="media-body">
												<h3 class="media-heading">TC</h3><hr>
											</div>
										</div>
									</a>
								</div>
