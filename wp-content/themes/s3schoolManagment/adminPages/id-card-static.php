			...
			<div class="container">
				<div class="row">
							...
							?>
								<div class="col-md-12">
									<div class="panel panel-info">
										<div class="panel-heading">
											<h3>ID Card Backside<br><small>Print Student Id Card</small></h3>
										</div>
								...
								<div id="printArea" class="col-md-12 printBG">
									...
									<div class="printArea" style="text-align: center;">
										...
										?>
										<?php
										$background_image_url = get_template_directory_uri() . '/img/gsm-s1b4.jpg';
										?>
										<!--	gsm-s2b3.jpg 	gsm-s3b5.jpg	  gsm-s1b4.jpg -->
					...
					background-size: cover;background-position: right; position:relative;">
													...
													<!--	gsm-s2b3.jpg 	gsm-s3b5.jpg	  gsm-s1b4.jpg			<p style="margin: 0;color:#fff"><b>If found please return to</b></p>-->
													<!-- </div>-->
							...
							if (isset($_GET['syear'])) { ?>
								...
								<div id="printArea" class="col-md-12 printBG">
									...
									<div class="printArea" style="text-align: center;">
										...
										if (isset($_GET['syear'])) {
											$query = "SELECT studentid,stdName,infoRoll,stdPresent,className,sectionName,stdImg,stdBrith,groupName,infoYear,stdPhone,stdFather,stdMother,stdBldGrp,stdAdmitYear FROM ct_student
								...
								WHERE infoYear = '$year' AND infoClass = $class";
										...
										?>
								  			...
								  			<h3 style="margin: 0;font-size: 17px;"><?= $s3sRedux['institute_name'] ?></h3>
												...
												?>
													<?php
													$background_image_url = get_template_directory_uri() . '/img/israb ali-03.jpg';
													?>
													<div style="width: 5.3cm;height: 8.7cm;background: blue;display: inline-block;margin: 5px;overflow: hidden;background-image: url('<?php echo $background_image_url; ?>');background-size: cover;background-position: center; position:relative;">
														...
														<div class="text-center">
															<img alt="Student_Image" width="90" height="93" style="border-radius:50px; border: 3px; border-style: solid;
                                    border-color:#033148; margin: 59px 0px 0px 5px;" src="<?php echo ($value->stdImg != "") ? $value->stdImg : get_template_directory_uri() . "/img/No_Image.jpg" ?>">
														</div>
														<p style="font-weight: bold; border-radius: 40px; margin-bottom: 0px; font-size:13.4px; margin: 4px -2px 0px 5px; color:#033148; margin-bottom:2px;min-height:25px; margin-left:-6px;display: flex;align-items: center;justify-content: center;  padding: 0px 18px; 
			    	 	font-family: sans-serif;"><?= $value->stdName  ?></p>

														<tr>
															<td style="width:20%;vertical-align:top;"><b>Father </b></td>
															<td style="vertical-align:top;">:</td>
															<td style="font-size:10.61px;"> <?= $value->stdFather ?> </td>
														</tr>
														<tr>
															<td style="width:20%;vertical-align:top;"><b> Mother </b></td>
															<td style="vertical-align:top;">:</td>
															<td style="font-size:10.5px;"> <?= $value->stdMother ?></td>
														</tr>
														<tr>
															<td style="width:21%;"><b>Class </b></td>
															<td style="vertical-align:top;">:</td>
															<td style="font-size:11.5px;"> <?= $value->className ?> </td>
														</tr>
														<tr>
															<td style="width:21%;"><b>Section </b></td>
															<td style="vertical-align:top;">:</td>
														...
														<tr>
															...
															<td style="vertical-align:top;">:</td>
															<td style="font-size:11.5px;"> <?= $value->infoRoll ?></td>
														</tr>
														<?php if ($value->groupName != '') { ?>
															<tr>
																<td style="width:31%;"><b>Group </b></td>
																<td style="vertical-align:top;">:</td>
																<td style="font-size:10.5px;"> <?= $value->groupName ?></td>
															</tr>
														<?php } ?>
														<tr>
															<td style="width:21%;"><b>Session </b></td>
															<td style="vertical-align:top;">:</td>
															<td style="font-size:11.5px;"> <?= $value->infoYear ?></td>
														</tr>
														</table>
													</div>
												...
												?>
													...
													<div style="width: 5.3cm;height: 8.7cm;background: blue;display: inline-block;margin: 5px;overflow: hidden;background-image: url('<?php echo $background_image_url; ?>');background-size: cover;background-position: center; position:relative;">
														...
														<!--<h3 style="margin: -3px 0 0 22px;font-size: 18px;font-weight: 750; color: #800000;letter-spacing: -.25px;"><?= $s3sRedux['institute_name'] ?></h3>-->
														<!--<p style="font-size: 12px; margin:3px 1px;color: white;"><?= $s3sRedux['institute_address'] ?></p> -->
														<div class="text-center"><img alt="Student_Image" width="86" height="88" style="border-radius:49px;
								  				margin: 78px 0px 0px 5px;" src="<?php echo ($value->stdImg != "") ? $value->stdImg : get_template_directory_uri() . "/img/No_Image.jpg" ?>">
														</div>
														<p style="font-weight: bold; border-radius: 40px; margin-bottom: 0px; font-size:13.5px;
			    	 	margin: 5px -2px 0px 5px; color:#065499; 
			    	 	padding: 0px 20px; margin-bottom:2px;min-height:25px;margin-left:-6px;display: flex;
			    	 	align-items: center;justify-content: center; text-transform: uppercase; padding: 0px 18px; font-family: sans-serif;"><?= $value->stdName  ?></p>
														...
														<table style="position:absolute; margin:1px 0 0 15px; width:95%; font-size:12px; color:black; text-align:left; border-collapse:collapse;">
															<style>
																.info-row {
																	display: grid;
																...
																.info-value {
																	...
																	/* first for colon, second for text */
															...
															<tr class="info-row">
																...
																<td class="info-value">
																	...
																	<span class="value-text"><?= htmlspecialchars($value->stdFather) ?></span>
																</td>
															</tr>
															...
															<tr class="info-row">
																...
																<td class="info-value">
																	<span class="colon">:</span>
																	<span class="value-text"><?= htmlspecialchars($value->stdMother) ?></span>
																</td>
															</tr>
															...
															<tr class="info-row">
																...
																<td class="info-value">
																	<span class="colon">:</span>
																	<span class="value-text"><?= date('d-m-Y', strtotime($value->stdBrith)) ?></span>
																</td>
															</tr>
															...
															<tr class="info-row">
																...
																<td class="info-value">
																	<span class="colon">:</span>
																	<span class="value-text"><?= htmlspecialchars($value->infoRoll) ?></span>
																</td>
															</tr>
															...
															<tr class="info-row">
																...
																<td class="info-value">
																	...
																	<span class="value-text">
																		...
																		$firstRow = isset($addressParts[0]) ? trim($addressParts[0]) : '';
																		$secondRow = isset($addressParts[1]) ? trim($addressParts[1]) : '';
																		$thirdRow = isset($addressParts[2]) ? trim($addressParts[2]) : '';
																		?>
																		<span style="line-height: 1.3">
																			<?= $firstRow ?><?= $secondRow ? ', ' . $secondRow : '' ?><br>
																		</span>
																		<?php if ($thirdRow): ?>
																			<?= $thirdRow ?>
																		<?php endif; ?>
												...
												?>
													<?php
													$background_image_url = get_template_directory_uri() . '/img/id-design-4-aided.jpeg';
													?>
													<div style="width: 5.3cm;height: 8.7cm;background: blue;display: inline-block;margin: 5px;overflow: hidden;background-image: url('<?php echo $background_image_url; ?>');background-size: cover;background-position: center; position:relative;">
														<!-- <img width="40" src="<?= $s3sRedux['instLogo']['url'] ?>" style="border-radius: 25px; margin: 14px 0 0 15px;">-->
														<!--<h3 style="margin: -3px 0 0 22px;font-size: 18px;font-weight: 750; color: #800000;letter-spacing: -.25px;"><?= $s3sRedux['institute_name'] ?></h3>-->
														<!--<p style="font-size: 12px; margin:3px 1px;color: white;"><?= $s3sRedux['institute_address'] ?></p> -->
														<div class="text-center">
															<img alt="Student_Image" width="90" height="93" style="border-radius:45px;margin: 61px 0px 0px 5px;" src="<?php echo ($value->stdImg != "") ? $value->stdImg : get_template_directory_uri() . "/img/No_Image.jpg" ?>">
														</div>
														<p style="font-weight: bold; border-radius: 40px; margin-bottom: 0px; font-size:14px;
			    	 	margin: 10px -2px 0px 5px; color:#2c3990; 
			    	 	padding: 0px 20px; margin-bottom:2px;min-height:28px;margin-left:-6px;
			    	 	display: flex;align-items: center;justify-content: center;  padding: 0px 18px; font-family: sans-serif;"><?= $value->stdName  ?></p>

														<!-- <p style="font-weight: bold;border-radius: 0px;padding: 0 10px; font-size:13px; margin-bottom: 0px;margin-top: 6px; color:#800000; padding:inherit; margin-left:-6px;display: flex;align-items: center;justify-content: center;"><?= $value->stdName  ?></p> -->
														<!-- This is student info details table start  -->
														<table style="position:absolute; margin: 1px 0 0 15px; width:95%;font-size:12px;color:black;text-align:left;">
															<!-- <tr>
										          ...
										          <td>:  <?= date('d-m-Y', strtotime($value->stdBrith)) ?></td>
															...
															<tr>
																...
																<td style="font-size:11px;">: <?= $value->stdMother ?></td>
															</tr>
															<tr>
																<td style="width:21%;"><b>Class </b></td>
										      ...
										      <td style="width:31%;"><b>Blood </b></td> 
										       <td><b>: <?= $value->stdBldGrp ?></b></td> 
												...
												?>
													<?php
													$background_image_url = get_template_directory_uri() . '/img/israb ali-02id.jpg';
													?>
													<div style="width: 5.3cm;height: 8.7cm;background: blue;display: inline-block;margin: 5px;overflow: hidden;background-image: url('<?php echo $background_image_url; ?>');background-size: cover;background-position: center; position:relative;">
														<!-- <img width="40" src="<?= $s3sRedux['instLogo']['url'] ?>" style="border-radius: 25px; margin: 14px 0 0 15px;">-->
														<!--<h3 style="margin: -3px 0 0 22px;font-size: 18px;font-weight: 750; color: #800000;letter-spacing: -.25px;"><?= $s3sRedux['institute_name'] ?></h3>-->
														...
														<div class="text-center">
															<img alt="Student_Image" width="90" height="93" style="border-radius:50px; border: 3px; border-style: solid;
                                    border-color:#123559; margin: 59px 0px 0px 5px;" src="<?php echo ($value->stdImg != "") ? $value->stdImg : get_template_directory_uri() . "/img/No_Image.jpg" ?>">
														</div>
														<p class="design-4-name" style="font-weight: bold; border-radius: 40px; margin-bottom: 0px; font-size:13.4px; margin: 4px -2px 0px 5px; color:#033148; margin-bottom:2px;min-height:25px; margin-left:-6px;display: flex;align-items: center;justify-content: center;  padding: 0px 18px; 
			    	 	font-family: sans-serif;"><?= $value->stdName  ?></p>

														<table class="design-4-table" style="position:absolute; margin: 1px 0 0 15px; 
									  width:95%;font-size:11px;color:black;text-align:left;">
															<tr>
																<td style="width:20%;;vertical-align:top; "><b>Father </b></td>
															...
															<tr>
																<td style="width:20%;"><b>Class </b></td>
																<td style="vertical-align:top; width: 3%;">:</td>
																<td style="font-size:11px;"><?= $value->className ?> </td>
															</tr>
															<tr>
																<td style="width:20%;"><b>Section </b></td>
																<td style="vertical-align:top; width: 3%;">:</td>
																<td style="font-size:11px;"><?= $value->sectionName ?></td>
															</tr>
															<tr>
																<td style="width:20%;"><b>Roll </b></td>
																<td style="vertical-align:top; width: 3%;">:</td>
																<td style="font-size:11px;"> <?= $value->infoRoll ?></td>
															</tr>
															<?php if ($value->groupName != '') { ?>
																<tr>
																	<td style="width:20%;"><b>Group </b></td>
																	<td style="vertical-align:top; width: 3%;">:</td>
																	<td style="font-size:11px;"> <?= $value->groupName ?></td>
																</tr>
															<?php } ?>
															<tr>
																<td style="width:20%;"><b>Session </b></td>
																<td style="vertical-align:top; width: 3%;">:</td>
																<td style="font-size:11px;"> <?= $value->infoYear ?></td>
															</tr>
														</table>
													</div>
...
<script type="text/javascript">
	(function($) {
		...
		document.addEventListener('keydown', function(event) {
			// Check if Ctrl and Shift and Q are all pressed simultaneously
			if (event.ctrlKey && event.shiftKey && event.key.toLowerCase() === 'q') {
				event.preventDefault(); // Prevent default browser actions if applicable
				print('printArea');
			}
		});
