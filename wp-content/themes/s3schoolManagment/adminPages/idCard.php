								...
								WHERE infoYear = '$year' AND infoClass = $class";
										...
										?>
								  			...
								  			<h3 style="margin: 0;font-size: 17px;"><?= $s3sRedux['institute_name'] ?></h3>
												...
												?>
													<?php
													$background_image_url = get_template_directory_uri() . '/img/abdul-basir.jpeg';
													?>
													<div style="width: 5.3cm;height: 8.7cm;background: blue;display: inline-block;margin: 5px;overflow: hidden;background-image: url('<?php echo $background_image_url; ?>');background-size: cover;background-position: center; position:relative;">
														...
														<div class="text-center">
															<img alt="Student_Image" width="95" height="95" style="border-radius:45px;margin: 45px 0px 0px 5px;" src="<?php echo ($value->stdImg != "") ? $value->stdImg : get_template_directory_uri() . "/img/No_Image.jpg" ?>">
														</div>
														<p style="font-weight: bold; border-radius: 40px; margin-bottom: 0px; font-size:14px;margin: 5px -2px 0px 5px; color:#800000; 
			    	 	padding: 0px 20px; margin-bottom:2px;min-height:28px;margin-left:-6px;display: flex;align-items: center;justify-content: center;  padding: 0px 20px; font-family: sans-serif;"><?= $value->stdName  ?></p>
												...
												?>
													<?php
													$background_image_url = get_template_directory_uri() . '/img/pathfinder kg-01.jpg';
													?>
													<div style="width: 5.3cm;height: 8.7cm;background: blue;display: inline-block;margin: 5px;overflow: hidden;background-image: url('<?php echo $background_image_url; ?>');background-size: cover;background-position: center; position:relative;">
														<!-- <img width="40" src="<?= $s3sRedux['instLogo']['url'] ?>" style="border-radius: 25px; margin: 14px 0 0 15px;">-->
														<!--<h3 style="margin: -3px 0 0 22px;font-size: 18px;font-weight: 750; color: #800000;letter-spacing: -.25px;"><?= $s3sRedux['institute_name'] ?></h3>-->
										       ...
										       <td><b>: <?= $value->stdBldGrp ?></b></td> 
												...
												?>
													...
													<div style="width: 5.3cm;height: 8.7cm;background: blue;display: inline-block;margin: 5px;overflow: hidden;background-image: url('<?php echo $background_image_url; ?>');background-size: cover;background-position: center; position:relative;">
														...
														<!--<p style="font-size: 12px; margin:3px 1px;color: white;"><?= $s3sRedux['institute_address'] ?></p> -->
														<div class="text-center">
															<img alt="Student_Image" width="100" height="105" style="border-radius:50px; border: 4px; border-style: solid;
                                    border-color:#E01F26; margin: 59px 0px 0px 5px;" src="<?php echo ($value->stdImg != "") ? $value->stdImg : get_template_directory_uri() . "/img/No_Image.jpg" ?>">
														</div>
														<p style="font-weight: bold; border-radius: 40px; margin-bottom: 0px; font-size:13.4px; margin: 4px -2px 0px 5px; color:#E01F26; margin-bottom:2px;min-height:25px; margin-left:-6px;display: flex;align-items: center;justify-content: center;  padding: 0px 18px; 
			    	 	font-family: sans-serif;"><?= $value->stdName  ?></p>

														<!-- <p style="font-weight: bold;border-radius: 0px;padding: 0 10px; font-size:13px; margin-bottom: 0px;margin-top: 6px; color:#800000; padding:inherit; margin-left:-6px;display: flex;align-items: center;justify-content: center;"><?= $value->stdName  ?></p> -->
														<!-- This is student info details table start  -->
														<table style="position:absolute; margin: 1px 0 0 15px; 
									  width:95%;font-size:11px;color:black;text-align:left;">

															<tr>
																<td style="width:20%;"><b>Father </b></td>
																<td style="font-size:10.61px;"> : <?= $value->stdFather ?> </td>
															</tr>
															<tr>
																<td style="width:20%;"><b> Mother </b></td>
																<td style="font-size:10.5px;"> : <?= $value->stdMother ?></td>
															</tr>
															<tr>
																<td style="width:20%;"><b>DoB</b></td>
																<td style="font-size:11.5px;"> : <?= date('d-m-Y', strtotime($value->stdBrith)) ?></td>
															</tr>
															<tr>
																<td style="width:20%;"><b>Blood </b></td>
																<td style="font-size:11.5px;"> : <?= $value->stdBldGrp ?></td>
															</tr>
															<!--<tr>
										          <td style="width:21%;"><b>Class </b></td>
										      ...
										      <td style="font-size:10.5px;"> :  <?= $value->groupName ?></td> 
										       ...
										       <td style="font-size:11.5px;"> : <?= $value->infoYear ?></td>
															...
															<tr>
																...
																<td style="font-size:11.5px;"> : <?= $value->stdPhone ?></td>
															</tr>
														</table>
														<!-- This is student info details table Closed  -->
														<!-- <img align="Principal_Signature" style="display: block; position:absolute; margin: 75px 0 0 111px;" width="60" src="<?= $s3sRedux['principalSign']['url'] ?>">-->
