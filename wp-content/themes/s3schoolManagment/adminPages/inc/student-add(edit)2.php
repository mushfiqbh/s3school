      ...
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <div class="row">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <input class="form-control" type="text" name="stdFather" placeholder="Father Name" value="<?= $edit->stdFather ?>" required>
                  </div>
                  <div class="col-md-3">
                    <label>Late ?</label><br>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-9">
                    ...
                    <input class="form-control" type="text" name="stdMother" placeholder="Mother Name" value="<?= $edit->stdMother ?>" required>
                  </div>
                  <div class="col-md-3">
                    <label>Late ?</label><br>
                    <label class="labelRadio">
              ...
              <div class="col-md-6">
                ...
                <select class="form-control" name="stdCurntYear" id="stdCurntYear" required>
                  <option value="">Select A Year..</option>
                   <?php 
                   if($edit->infoClass == 60 || $edit->infoClass == 61){
                  $current_year = date("Y");
            ...
            <div class="form-group">
              <label>ID NO: <span>*</span></label>
              <input id="stdRoll" data-std="<?= $edit->studentid ?>" class="form-control" type="text" name="stdRoll" placeholder="ID NO" value="<?= $edit->infoRoll ?>" required>
    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        <div class="row">
          ...
          <div class="form-group">
            <label>ID NO: <span>*</span></label>
            <input id="stdRoll" datd-std='x' class="form-control" type="text" name="stdRoll" placeholder="ID NO" required>
            <span class="warning text-danger"></span>
          </div>
