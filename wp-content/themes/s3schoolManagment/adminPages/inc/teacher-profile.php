                        ...
                        foreach ($assignedSubjects as $index => $subjectId) {
                            ...
                            if ($subject) {
                                ...
                                if ($sectionId === 'all') {
                                    ...
                                    $section = $wpdb->get_row($wpdb->prepare("SELECT sectionName FROM ct_section WHERE sectionid = %d", $sectionId));
                                    if ($section) {
                                        $sectionName = $section->sectionName;
                                    }
                                }
                                
                                echo '<div>- Class: ' . esc_html($class->className ?? 'N/A') . ', Section: ' . esc_html($sectionName) . ', Subject: ' . esc_html($subject->subjectName) . '</div>';
                            }
                        }
                    } else {
