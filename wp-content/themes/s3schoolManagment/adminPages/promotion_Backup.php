<?php
/*
** Template Name: Admin Promotion 2
*/ 
...
if (isset($_POST['promotStu'])) {
	if ($_POST['promotion'] < 1) {
		...
		if($assignRoll == ''){
			...
			$lastRoll = $lastRoll[0]->infoRoll + 1;
		}
			  ...
			  <div >
			  	...
			  	<?php
			  		...
			  		if (isset($_GET['syear'])) {
			  			...
			  			$querry = "SELECT * FROM `ct_studentPoint`
			  								...
			  								LEFT JOIN ct_studentinfo ON ct_student.studentid = ct_studentinfo.infoStdid AND $class = ct_studentinfo.infoClass AND '$year' = ct_studentinfo.infoYear
												...
												WHERE infoYear = '$year' AND spExam = $exam AND infoClass = $class AND stdCurrentClass = $class AND stdCurntYear = '$year' AND spFaild = 0";
