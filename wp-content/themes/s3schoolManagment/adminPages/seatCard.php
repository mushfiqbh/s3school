								...
								foreach ($groupsBy as $value) {
									?>
										<div style="width: calc(50% - 50px);height: calc(2.338in - 44px);display: inline-block;margin: 5px 10px;border: 2px solid #333;overflow: hidden;padding: 10px;">
											...
											<div style="text-align: center; margin-bottom: 7px; position: relative;">
									  		<div style="width: 20%; float: left; text-align: left;">
									  			<?php if (!empty($value->stdImg)) { ?>
										  			<img style="height: 50px; " alt="<?= $value->stdName ?>_img" src="<?= $value->stdImg ?>">
									  			<?php }else{ ?>
										  			<img style="height: 50px; " alt="<?= $value->stdName ?>_img" src="<?= get_template_directory_uri() ?>/img/No_Image.jpg">
									  			<?php } ?>
									  		</div>
								  		...
								  		<div style="width: 65%; float: left;line-height: 18px">
								  		...
								  		<div style="width: 35%; float: right;">
												<h3 style="margin: 0 0 2px 0; text-align: center;"><b>Roll<br> <?= $value->infoRoll ?></b></h3>
								  		</div>
								  	</div>
