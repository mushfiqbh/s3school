...
function s3s_paystation_sync_pending_status(WP_REST_Request $request)
{
    ...
    foreach ($pending_transactions as $transaction) {
        ...
        if (is_wp_error($status_result)) {
            ...
            // If the transaction has been pending for more than 24 hours, mark as failed
            // $created_at = $transaction['created_at'];
            // $bdt_now = get_bdt_time();
            // $hours_pending = (strtotime($bdt_now) - strtotime($created_at)) / 3600;
            ...
            //             'error'   => $error_message,
            //             'note'    => 'Auto-failed after 24 hours pending',
            //             'checked_at' => get_bdt_time(),
            //         ),
            //     ));
            //     $details[] = array(
            ...
            //         'action'         => 'auto_failed',
            //         'reason'         => "Pending > 24h: {$error_message}",
            //     );
            //     $failed++;
            // } else {
