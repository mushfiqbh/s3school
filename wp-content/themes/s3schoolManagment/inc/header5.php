				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<a href="<?= home_url() ?>" class="pull-left">
							<img width="<?= $s3sRedux['logo_width']; ?>" class="img-responsive" style="width:100%" src="<?= $s3sRedux['logo_upload']['url']; ?>">
						</a>
					...
					<!--		<li class="text-right">-->
					<!--			<img style="height: 85px" class="img-responsive pull-right" src="<?= get_template_directory_uri() ?>/img/flag.gif">-->
					<!--		</li>-->
