...
<div id="index2" class="b-page-content with-layer-bg">
  <div class="b-layer-big container" id="halfSlider">
    <div class="row">
      ...
      <div class="col-md-4" style="min-height: 300px;">
        <style>
          .admission-open-card{position:relative;overflow:hidden;border-radius:18px;padding:20px;background:linear-gradient(135deg,#ffffff 0%,#f1f5ff 40%,#eef2ff 100%);border:1px solid rgba(59,130,246,.18);box-shadow:0 12px 30px rgba(15,23,42,.12);transform:translateY(0);transition:transform .2s ease,box-shadow .2s ease}
          .admission-open-card:before{content:"";position:absolute;top:-90px;right:-90px;width:260px;height:260px;background:radial-gradient(circle,rgba(59,130,246,.35),rgba(59,130,246,0));pointer-events:none}
          .admission-open-card:hover{transform:translateY(-3px);box-shadow:0 16px 40px rgba(15,23,42,.16)}
          .admission-open-badge{display:inline-flex;align-items:center;gap:6px;padding:4px 10px;border-radius:999px;font-size:12px;font-weight:800;letter-spacing:.3px;background:rgba(16,185,129,.14);color:#065f46;border:1px solid rgba(16,185,129,.25)}
          .admission-open-header{display:flex;gap:12px;align-items:center;margin-top:16px;}
          .admission-open-icon{width:46px;height:46px;border-radius:14px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;box-shadow:0 12px 22px rgba(37,99,235,.25)}
          .admission-open-title{margin:0;font-size:20px;font-weight:900;color:#0f172a;line-height:1.15}
          .admission-open-sub{margin-top:4px;font-size:13px;color:#475569;font-weight:600}
          .admission-open-actions{margin-top:24px}
          .admission-open-btn{width:100%;display:flex;align-items:center;justify-content:center;gap:8px;padding:12px 14px;border-radius:12px;border:0;font-weight:900;letter-spacing:.2px;color:#fff;background:linear-gradient(135deg,#2563eb,#1d4ed8);box-shadow:0 10px 22px rgba(29,78,216,.25);transition:transform .2s ease,box-shadow .2s ease}
          .admission-open-btn:hover,.admission-open-btn:focus{color:#fff;transform:translateY(-1px);box-shadow:0 14px 28px rgba(29,78,216,.32)}
          .admission-open-foot{margin-top:10px;font-size:12px;color:#64748b;font-weight:700;display:flex;gap:10px;align-items:center;flex-wrap:wrap}
          .admission-open-dot{width:6px;height:6px;border-radius:999px;background:#22c55e;box-shadow:0 0 0 4px rgba(34,197,94,.12)}
        </style>
        <div class="admission-open-card" style="margin-top: 5px;">
          <div class="admission-open-badge">
            <span class="admission-open-dot"></span>
            Admission Open
          </div>
          <div class="admission-open-header">
            <div class="admission-open-icon">
              <i class="fa fa-graduation-cap" aria-hidden="true"></i>
            </div>
            <div>
              <div class="admission-open-title">Apply Online</div>
              <div class="admission-open-sub">Fast, easy & secure admission application</div>
            </div>
          </div>
          <div class="admission-open-actions">
            <a href="<?= home_url("apply-online"); ?>" class="btn admission-open-btn">
  ...
  <div style="background: #473399; padding:50px 0;margin-top: 60px;" class="animated fadeInUpBig" data-wow-duration="1000ms" data-wow-delay="500ms">
        ...
        <div class="col-md-4">
          ...
          <div class="letestNewsDiv" style="height: 280px; overflow: auto;">
            <?php
              $args = [
                'post_status'   => 'publish',
                'category_name' => 'latest-news',
