				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 footer_social"> 
							<p> Stay with Us </p> 
							<a href="https://www.facebook.com/saarc.icb" target="_blank"><i class="fa fa-facebook"></i></a>&nbsp;							<a href="" target="_blank"><i class="fa fa-twitter"></i></a>&nbsp;							<a href="" target="_blank"><i class="fa fa-google-plus"></i></a>&nbsp;							<a href="" target="_blank"><i class="fa fa-youtube"></i></a>
						</div>
						
						<div class="col-md-6 footer_social">
							<span style='float: right;'>
								<p style='float: right; margin-left: 10px;'> Contact Us - 01742-787473 </p>
