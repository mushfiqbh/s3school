<?php
/*
Template Name: Former Staffs Page
*/
                                                    ...
                                                    <article class="staff-card">
                                                        ...
                                                        <div class="staff-content">
                                                            ...
                                                            <?php if (!empty($staff->staffDesignation)) : ?>
                                                                <p class="staff-designation">Former <?php echo esc_html($staff->staffDesignation); ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </article>
                                                </a>
                                    ...
                                    <div class="staff-detail-wrapper">
                                        <div class="staff-detail-header">
                                            ...
                                            <div class="staff-detail-meta">
                                                ...
                                                <?php if (!empty($staff->staffDesignation)) : ?>
                                                    <div class="designation">Former <?php echo esc_html($staff->staffDesignation); ?></div>
                                                <?php endif; ?>
