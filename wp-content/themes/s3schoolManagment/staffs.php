                ...
                <div class="col-xs-12 col-sm-7 col-md-8 col-lg-9">
                    <div class="b-blog-items-holder">
                        <div class="clearfix">
                            <?php if (!$staff_id) : ?>
                                <?php
                                $staff_members = $wpdb->get_results('SELECT staffid, staffName, staffImg, staffDesignation FROM ct_staff WHERE status="Present" ORDER BY staff_serial, staffName ASC');
                                ?>
