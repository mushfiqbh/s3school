						...
						<div class="clearfix">
							<?php if (!$teacher_id) : ?>
								...
								$teachers = $wpdb->get_results($wpdb->prepare(
									'SELECT teacherid, teacherName, teacherImg, teacherDesignation, teacher_serial FROM ct_teacher WHERE status = %s AND (teacherDesignation IS NULL OR teacherDesignation NOT LIKE %s) ORDER BY teacher_serial, teacherName ASC',
									'Present',
									'%Lecturer%'
								));
								?>
													...
													<article class="teacher-card">
														...
														<div class="teacher-content">
															...
															<?php if (!empty($teacher->teacherDesignation)) : ?>
																<p class="teacher-designation"><?php echo esc_html($teacher->teacherDesignation); ?></p>
															<?php endif; ?>
														</div>
													</article>
												</a>
									...
									<div class="teacher-detail-wrapper">
										<div class="teacher-detail-header">
											...
											<div class="teacher-detail-meta">
												...
												<?php if (!empty($teacher->teacherDesignation)) : ?>
													<div class="designation"><?php echo esc_html($teacher->teacherDesignation); ?></div>
												<?php endif; ?>
